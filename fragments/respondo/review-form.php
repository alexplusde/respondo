...
$yform->setValueField('text', ['title', rex_i18n::msg('respondo.entry.title'), '', '0', '']);
...
if (rex_addon::get('yform_spam_protection')->isAvailable()) {
    $yform->setValueField('spam_protection', ['honeypot', 'Bitte nicht ausfüllen.', 'Ihre Anfrage wurde als Spam erkannt und gelöscht. Bitte versuchen Sie es in einigen Minuten erneut oder wenden Sie sich persönlich an uns.', 0]);
}
?>
